    ...
    public static function get(): array
    {
        return [
            ...
            Textarea::make('site_description')
                ...
                ->columnSpanFull(),
            Grid::make(2)->schema([
                TextInput::make('application_fee_percent')->numeric()->minValue(0)->maxValue(100)->default(2)->prefix('%')->label('Application Fee Percent'),
                TextInput::make('site_address')->label(__('Site Address')),
            ]),
            Grid::make()->schema([
