...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-justify-center dz-bg-white">
        @if(! is_null($error))
        ...
        <div @click="$refs.input.click()" class="dz-border dz-border-dashed dz-rounded dz-border-gray-500 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging" class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-3 dz-py-8 dz-h-full">
                    ...
                    <p class="dz-text-md dz-text-gray-600">Drop here or <span class="dz-font-semibold dz-text-black">Browse files</span></p>
                </div>
